...
class RuleReaderTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.root_rules = os.path.join(self.base_dir, "rules.md")
        self.doc_rules = os.path.join(self.base_dir, "doc", "rules.md")
        self.or_rules = os.path.join(self.doc_or_dir, "rules.md")
